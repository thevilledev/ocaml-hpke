...
The source holds 13 vectors, all in Base mode, and the corpus keeps all of
them:
...
- As `draft_vectors`, the seven SHA-3 vectors, in full. Four use SHAKE: P-256
  with SHAKE128 and AES-128-GCM, P-384 with SHAKE256 and AES-256-GCM,
  MLKEM768-P256 with SHAKE128 and AES-256-GCM, and MLKEM768-X25519 with
  SHAKE256 and ChaCha20-Poly1305. Three use TurboSHAKE: X25519 with
  TurboSHAKE128, and X448 and ML-KEM-1024 with TurboSHAKE256. The one-stage KDFs exist only in the key schedule of
...
- `kem_only_vectors`, for a vector whose KDF the library lacks, is empty.
